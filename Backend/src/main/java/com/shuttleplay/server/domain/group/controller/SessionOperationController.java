...
public class SessionOperationController {
    ...
    @PatchMapping("/queues/auto-fill") public ResponseEntity<ApiResponse<Map<String, Object>>> updateAutoFill(@AuthenticationPrincipal CustomUserDetails user, @PathVariable Long sessionId, @RequestBody Map<String, Object> body) { return ok(service.updateAutoFill(userId(user), sessionId, body)); }
