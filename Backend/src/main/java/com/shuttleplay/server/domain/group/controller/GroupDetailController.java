...
public class GroupDetailController {
    ...
    @PostMapping("/join") public ResponseEntity<ApiResponse<Map<String, Object>>> joinBySharedLink(@AuthenticationPrincipal CustomUserDetails u, @PathVariable Long groupId) { return ok(service.joinBySharedLink(u.getId(), groupId)); }
    ...
    @PostMapping("/sessions") public ResponseEntity<ApiResponse<Map<String, Object>>> createSession(@AuthenticationPrincipal CustomUserDetails u, @PathVariable Long groupId, @RequestBody Map<String, Object> b) { return ok(service.createSession(u.getId(), groupId, b)); }
